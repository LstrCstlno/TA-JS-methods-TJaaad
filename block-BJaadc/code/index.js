...
console.log(`The last charecter of "${message}" is ${message.charAt(42)}`);
...
let slicedMessage = message.slice(3, 6);
console.log(slicedMessage.includes("you"));

// Check and log whether the word from index 7 to 8 is "a" or not
let slicedMessage1 = message.slice(7, 8);
console.log(slicedMessage1.includes("a"));

// Check and log whether the last 3 character in message is "no!" or not (you can use -3 in slice)
let slicedMessage2 = message.slice(-3);
console.log(slicedMessage2.includes("no!"));

// Check and log whether the last 5 character in message is "no!" or not
let slicedMessage3 = message.slice(-5);
console.log(slicedMessage3.includes("no!"));
